...
/** listInterfaceInfoVOByPageGet GET /api/interfaceInfo/list/page */
export async function listInterfaceInfoVoByPageGetUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listInterfaceInfoVOByPageGetUsingGETParams,
  options?: { [key: string]: any },
) {
